...
N_LIB_PRIVATE N_NIMCALL(tyObject_SocketImpl__aIhANOOoETolVz9cccNO9cRQ*, makeSocket)(NimStringDesc* ip, NI port) {
	...
	tyObject_SocketImpl__aIhANOOoETolVz9cccNO9cRQ* socket_1;
	nimfr_("makeSocket", "C:\\Users\\yovel\\Desktop\\Nim Projects\\sock.nim");
{	result = NIM_NIL;
	nimln_(4, "C:\\Users\\yovel\\Desktop\\Nim Projects\\sock.nim");
	echoBinSafe(TM__jX4F7m7vnVMCP9aFdJ0yDdw_2, 1);
	nimln_(5, "C:\\Users\\yovel\\Desktop\\Nim Projects\\sock.nim");
	socket_1 = newSocket__pureZnet_198(((tyEnum_Domain__Q79bEtFARvq0ekDNtvj3Vqg) 2), ((tyEnum_SockType__NQT1bItGG2X9byGdrWX7ujw) 1), ((tyEnum_Protocol__dqJ1OqRGclxIMMdSLRzzXg) 6), NIM_TRUE, NIM_FALSE);
	nimln_(6, "C:\\Users\\yovel\\Desktop\\Nim Projects\\sock.nim");
	echoBinSafe(TM__jX4F7m7vnVMCP9aFdJ0yDdw_4, 1);
	nimln_(7, "C:\\Users\\yovel\\Desktop\\Nim Projects\\sock.nim");
	connect__pureZnet_1107(socket_1, ip, ((NU16) (port)));
	nimln_(8, "C:\\Users\\yovel\\Desktop\\Nim Projects\\sock.nim");
	echoBinSafe(TM__jX4F7m7vnVMCP9aFdJ0yDdw_6, 1);
	nimln_(9, "C:\\Users\\yovel\\Desktop\\Nim Projects\\sock.nim");
	result = socket_1;
	goto BeforeRet_;
	}BeforeRet_: ;
	popFrame();
...
static N_INLINE(NimStringDesc*, recv__pureZnet_660)(tyObject_SocketImpl__aIhANOOoETolVz9cccNO9cRQ* socket_0, NI size, NI timeout, tySet_tyEnum_SocketFlag__4xio0cAXR7XG4pF9bVcpxEg flags) {
	...
	NI T1_;
	nimfr_("recv", "C:\\Users\\yovel\\.choosenim\\toolchains\\nim-1.6.10\\lib\\pure\\net.nim");
	result = NIM_NIL;
	nimln_(1545, "C:\\Users\\yovel\\.choosenim\\toolchains\\nim-1.6.10\\lib\\pure\\net.nim");
	...
	nimln_(1546, "C:\\Users\\yovel\\.choosenim\\toolchains\\nim-1.6.10\\lib\\pure\\net.nim");
	T1_ = (NI)0;
	T1_ = recv__pureZnet_652(socket_0, (&result), size, timeout, flags);
	(void)(T1_);
	popFrame();
	return result;
}
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, recv)(tyObject_SocketImpl__aIhANOOoETolVz9cccNO9cRQ* sock, NI size) {
	NimStringDesc* result;
	nimfr_("recv", "C:\\Users\\yovel\\Desktop\\Nim Projects\\sock.nim");
{	result = NIM_NIL;
	nimln_(12, "C:\\Users\\yovel\\Desktop\\Nim Projects\\sock.nim");
	echoBinSafe(TM__jX4F7m7vnVMCP9aFdJ0yDdw_8, 1);
	nimln_(13, "C:\\Users\\yovel\\Desktop\\Nim Projects\\sock.nim");
...
N_LIB_PRIVATE N_NIMCALL(void, send)(tyObject_SocketImpl__aIhANOOoETolVz9cccNO9cRQ* sock, NimStringDesc* data) {
	nimfr_("send", "C:\\Users\\yovel\\Desktop\\Nim Projects\\sock.nim");
	nimln_(16, "C:\\Users\\yovel\\Desktop\\Nim Projects\\sock.nim");
	echoBinSafe(TM__jX4F7m7vnVMCP9aFdJ0yDdw_10, 1);
	nimln_(17, "C:\\Users\\yovel\\Desktop\\Nim Projects\\sock.nim");
	send__pureZnet_754(sock, data, 2);
	popFrame();
}
N_LIB_PRIVATE N_NIMCALL(void, close)(tyObject_SocketImpl__aIhANOOoETolVz9cccNO9cRQ* sock) {
	nimfr_("close", "C:\\Users\\yovel\\Desktop\\Nim Projects\\sock.nim");
	nimln_(20, "C:\\Users\\yovel\\Desktop\\Nim Projects\\sock.nim");
	echoBinSafe(TM__jX4F7m7vnVMCP9aFdJ0yDdw_12, 1);
	nimln_(21, "C:\\Users\\yovel\\Desktop\\Nim Projects\\sock.nim");
